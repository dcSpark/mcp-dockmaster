use tauri::State;
use mcp_core::features::mcp_proxy::{
...
pub async fn register_tool(
    ...
    mcp_core::features::mcp_proxy::register_tool(state.inner(), request).await
}

/// List all registered tools
#[tauri::command]
pub async fn list_tools(state: State<'_, MCPState>) -> Result<Vec<Value>, String> {
    mcp_core::features::mcp_proxy::list_tools(state.inner()).await
}
...
pub async fn list_all_server_tools(state: State<'_, MCPState>) -> Result<Vec<Value>, String> {
    mcp_core::features::mcp_proxy::list_all_server_tools(state.inner()).await
}
...
pub async fn discover_tools(
    ...
    mcp_core::features::mcp_proxy::discover_tools(state.inner(), request).await
}
...
pub async fn execute_proxy_tool(
    ...
    mcp_core::features::mcp_proxy::execute_proxy_tool(state.inner(), request).await
}
...
pub async fn update_tool_status(
    ...
    mcp_core::features::mcp_proxy::update_tool_status(state.inner(), request).await
}
...
pub async fn update_tool_config(
    ...
    mcp_core::features::mcp_proxy::update_tool_config(state.inner(), request).await
}
...
pub async fn uninstall_tool(
    ...
    mcp_core::features::mcp_proxy::uninstall_tool(state.inner(), request).await
}
...
pub async fn execute_tool(
    ...
    mcp_core::features::mcp_proxy::execute_tool(state.inner(), request).await
}
...
pub async fn restart_tool_command(
    ...
    mcp_core::features::mcp_proxy::restart_tool_command(state.inner(), tool_id).await
}
